...
public class InvertBST {
    ...
    private static MyBinarySearchTree.Node invertBST(MyBinarySearchTree.Node root) {
        if (root == null) {return null;}

        MyBinarySearchTree.Node right = invertBST(root.right);
        MyBinarySearchTree.Node left = invertBST(root.left);
